...
object Sounds {
    ...
    val LEGENDARY_CATCH = sound(key("entity.ender_dragon.death"), Source.VOICE, 0.3f, 2f)
    val LEGENDARY_CATCH_EXPLODE = sound(key("entity.generic.explode"), Source.VOICE, 1f, 1f)
    ...
    val TRANSCENDENT_CATCH_SPAWN = sound(key("entity.elder_guardian.curse"), Source.VOICE, 1f, 0.5f)
    val CELESTIAL_CATCH = sound(key("item.totem.use"), Source.VOICE, 2f, 0.75f)
    val CELESTIAL_CATCH_SPAWN = sound(key("item.trident.thunder"), Source.VOICE, 3f, 1.25f)
